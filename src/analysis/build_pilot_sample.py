...
# prereg §3 — 사용자 상태 6변수 3패턴
STATE_VARS = ["급여이체", "자동이체", "카드실적", "첫거래", "비대면가입", "청약보유"]
PATTERNS = {
    "P-많음": {v: True for v in STATE_VARS},
    "P-일부": {"급여이체": True, "자동이체": True, "카드실적": False,
               "첫거래": False, "비대면가입": True, "청약보유": False},
    "P-없음": {v: False for v in STATE_VARS},
}
